...
| 标识符 | 类型 | 数组结构 | 说明 |
| :--- | :--- | :--- | :--- |
| **0** | **章节标题** | `[0, "章节标题"]` | 更新剧本章节标题 |
| **1** | **节点标签** | `[1, "label_name"]` | 标签/跳转点 |
| **2** | **背景** | `[2, "bg_name"]` | 背景图片切换 |
| **3** | **对话** | `[3, "说话人", "内容", [立绘列表]]` | 说话人与台词内容，立绘列表可选，仅在立绘状态变化时出 |
| **4** | **选项** | `[4, [["文字", "跳转", "表达式"], ...]]` | 分支选项及逻辑判断 |
| **5** | **跳转** | `[5, "target_label"]` | 无条件跳转节点 |
